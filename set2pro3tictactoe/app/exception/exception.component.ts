...
export class ExceptionComponent implements OnInit {
  ...
  submit2(): void
  {
    ...
    this.v2 = this.turn;
    // tslint:disable-next-line: max-line-length
    if ( (this.v2 === this.v1 && this.v2 === this.v3) || (this.v2 === this.v5 && this.v2 === this.v8))
    {
      if (this.turn === 'X')
      {
        this.x = this.x + 1;
  ...
  submit3(): void
  {
    ...
    this.v3 = this.turn;
    // tslint:disable-next-line: max-line-length
    if ( (this.v3 === this.v2 && this.v3 === this.v1) || (this.v3 === this.v6 && this.v3 === this.v9) || (this.v3 === this.v5 && this.v3 === this.v7))
    {
      if (this.turn === 'X')
      {
        this.x = this.x + 1;
  ...
  submit4(): void
  {
    ...
    this.v4 = this.turn;
    // tslint:disable-next-line: max-line-length
    if ( (this.v4 === this.v1 && this.v4 === this.v7) || (this.v4 === this.v5 && this.v4 === this.v6))
    {
      if (this.turn === 'X')
      {
        this.x = this.x + 1;
